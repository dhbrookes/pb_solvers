...
public:
    ...
    const ShPt get_sph_posj(int j) const
                                     { return pos_[j].convert_to_spherical(); }
...
public:
    ...
    const double get_ai(int i) const
                                             { return molecules_[i].get_a(); }
    const double get_Mi(int i) const
                                             { return molecules_[i].get_m(); }
    const double get_qij(int i, int j) const
                                           { return molecules_[i].get_qj(j); }
    const EPt get_posij(int i, int j) const
                                         { return molecules_[i].get_posj(j); }
    const ShPt get_sph_posij(int i, int j) const
                                     { return molecules_[i].get_sph_posj(j); }
