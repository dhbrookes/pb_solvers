...
protected :
  ...
  string poty[7] = {"# Data from PBAM Electrostat run",
    "# My runname is /Users/lfelberg/Desktop/pot_y_4.00.dat",
    "units internal", "grid 11 11", "axis y 4",
    "origin -7.2 -15.2", "delta 1.30909 2.03636"};
  string potz[7] = {"# Data from PBAM Electrostat run",
    "# My runname is /Users/lfelberg/Desktop/pot_z_-1.00.dat","units internal",
    "grid 11 11","axis z -1","origin -7.2 -7.2","delta 1.30909 1.30909"};
