...
protected :
  ...
  double Mol1F[3] = {-1.1477e-07, -0.000154557, -0.000595584};
  double Mol2F[3] = {0.00112017, 8.11758e-05, 0.000297515};
  double Mol3F[3] = {-0.00111977, 7.32015e-05, 0.000297926};
...
//    charges[0] = 2.0; posCharges[0] = pos[molInd];
//    charges[1] = 2.0; posCharges[1] = pos[molInd] + Pt(1.0,0,0);
//    charges[2] = 2.0; posCharges[2] = pos[molInd] + Pt(0,1.0,0);
//    
//    Molecule molNew( M, 2.0, charges, posCharges, pos[molInd]);
//    mol_.push_back( molNew );
//  }
...
//  for (int molInd = 0; molInd < 2; molInd ++ )
//  {
//    int M = 3; vector<double> charges(3); vector<Pt> posCharges(3);
//    charges[0] = 2.0; posCharges[0] = pos[molInd];
...
//  {
//    cout << " This Energy for " << n << ":  " << EnTest.get_omega_i_int(n) << endl;
//    cout << " This force for " << n << ":  " << FoTest.get_fi(n)[0] <<
//    ", " << FoTest.get_fi(n)[1] << ", " << FoTest.get_fi(n)[2] << endl;
//  }
//}
//    EXPECT_NEAR( FoTest.get_fi(0)[n]/Mol1F[n], 1.0, preclim);
//    EXPECT_NEAR( FoTest.get_fi(1)[n]/Mol2F[n], 1.0, preclim);
