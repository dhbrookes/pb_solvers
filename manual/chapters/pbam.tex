...
\hline
\T runtype dynamics &  \param{outname}  \param{ntraj} & \parbox[t]{\colthree}{Will perform a brownian dynamics run. A directory where trajectory information will be stored in and the number of trajectories is required.\B}  \\
