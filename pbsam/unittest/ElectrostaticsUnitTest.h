...
//{
//  int pol(5), nmol(1);
//  PQRFile pqr(test_dir_loc + "barnase_barstar/1BRS_chainA_p1.5d3_s5i1.pqr");
//  vector<shared_ptr<Molecule> > mols;
//  for (int i=0; i<nmol; i++)
//    mols.push_back(make_shared<Molecule>(0, 0, "stat", pqr.get_charges(),
//                                         pqr.get_atom_pts(), pqr.get_radii(),
...
//
//
//TEST_F(ElectroUTest, barstar_test)
//{
//  int pol(5), nmol(1);
//  PQRFile pqr(test_dir_loc + "barnase_barstar/1BRS_chainD_p1.5d3_s5i1.pqr");
//  vector<shared_ptr<Molecule> > mols;
//  for (int i=0; i<nmol; i++)
//    mols.push_back(make_shared<Molecule>(0, 0, "stat", pqr.get_charges(),
//                                         pqr.get_atom_pts(), pqr.get_radii(),
...
//  
//  string istart = test_dir_loc + "imat_test/imat.sp";
//  string estart = test_dir_loc + "barnase_barstar/1BRS_chainD_0.05_p30.0.";
//  vector<vector<string> > imat_loc(sys->get_n());
//  string exp_str;
//  
//  vector<shared_ptr<HMatrix> > Hmat(sys->get_n());
...
//  }
//  
//  sys->write_to_pqr(test_dir_loc+"barstar_out.pqr");
//  
//  Electrostatic estat(Hmat, sys, SHCalcTest, BesselCal, cst, pol, 50);
//  estat.print_3d_heat(test_dir_loc + "barstar_map.out");
//  estat.print_dx(test_dir_loc + "barstar_mol.dx");
//}
